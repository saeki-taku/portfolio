<footer class="footer">
  <ul class="c-foot-menu__list" id="js-page-scroll__foot">
    <li class="c-foot-menu__item"><a href="<?= esc_url(home_url('/')) ?>" class="c-foot-menu__link">TOP</a></li>
    <?php if (is_home()) : ?>
      ...
      <li class="c-foot-menu__item"><a href="#js-contact__anchor" class="c-foot-menu__link">CONTACT</a></li>
    <?php else : ?>
      <!--トップページ以外-->
